...
namespace PCAN.Shard.Tools
{
    public static class CRC
    {
        static byte[] CRC8Table = new byte[]
      {
            ...
            216, 91, 5, 231, 185, 140, 210, 48, 110, 237, 179, 81, 15, 78, 16, 242,
            172, 47, 113, 147, 205, 17, 79, 173, 243, 112, 46, 204, 146, 211, 141,
            111, 49, 178, 236, 14, 80, 175, 241, 19, 77, 206, 144, 114, 44, 109,
            51, 209, 143, 12, 82, 176, 238,50, 108, 142, 208, 83, 13, 239, 177,
            240, 174, 76, 18, 145, 207, 45, 115, 202, 148, 118, 40, 171, 245, 23,
            73, 8, 86, 180, 234, 105, 55, 213, 139, 87, 9, 235, 181, 54, 104, 138,
            212, 149, 203, 41, 119, 244, 170, 72, 22, 233, 183, 85, 11, 136, 214,
            52, 106, 43, 117, 151, 201, 74, 20, 246, 168, 116, 42, 200, 150, 21,
        ...
        static readonly uint[] CRC32Table = new uint[256]
   {
        ...
        public static byte ComputeCRC8(byte[] buffer)
        {
            byte crc = 0;
            foreach (var item in buffer)
            {
                crc = CRC8Table[crc ^ item];
        ...
        /// <summary>
        /// 计算字节数组的 CRC32 值（初始值为 0xFFFFFFFF，结果取反）
        /// </summary>
